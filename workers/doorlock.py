...
SWVER_CHARACTERISTIC_UUID = "00002a26-0000-1000-8000-00805f9b34fb"

BATTERY_SERVICE_UUID =        "0000180f-0000-1000-8000-00805f9b34fb"
BATTERY_CHARACTERISTIC_UUID = "00002a19-0000-1000-8000-00805f9b34fb"

class DoorlockDeviceStatus:
    def __init__(
        self,
        worker,
        mac: str,
        ...
        self.worker = worker  # type: DoorlockWorker
        self.mac = mac.lower()
        self.name = name
        self.model = model
...
class DoorlockWorker(BaseWorker):
    def _setup(self):
        self.last_status = []
        for name, mac in self.devices.items():
            _LOGGER.info("Adding %s device '%s' (%s)", repr(self), name, mac)
            self.last_status.append(DoorlockDeviceStatus(self, mac, name))            
    ...
    def status_update(self):
        ...
        for device in self.last_status:
            ...
            switch_func = retry(load_device_state, retries=self.command_retries)
            try:
                switch_func(device)
